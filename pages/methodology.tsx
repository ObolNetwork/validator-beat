...
/** Tiny six-slice pizza (theme-aware via --theme-risk-* vars). */
function MiniPizza({ colors }: { colors: SliceColor[] }) {
  const cx = 24;
  const cy = 24;
  const r = 22;
  const gap = 4;
  ...
  return (
    <div className="vb-methodology">
      ...
      <main className="vb-methodology__main" id="main-content">
        ...
        <section>
          <AnchorHeading id="stages">Stages</AnchorHeading>
          <div className="vb-stage-row">
            <MiniPizza colors={STAGE_EXAMPLES[0]} />
            <p>
              <strong>
          ...
          <div className="vb-stage-row">
            <MiniPizza colors={STAGE_EXAMPLES[1]} />
            <p>
              <strong>
          ...
          <div className="vb-stage-row">
            <MiniPizza colors={STAGE_EXAMPLES[2]} />
            <p>
              <strong>
                {STAGE_META[2].name} — {STAGE_META[2].kind}:
              </strong>{" "}
              one failure won&apos;t slash you or take you offline.{" "}
        ...
        <section>
          <AnchorHeading id="six-slices">The six slices</AnchorHeading>
          <ol>
            {SLICES.map((s) => (
              <li key={s.id}>
          ...
          <AnchorHeading id="active-active" as="h3">
        ...
        <section>
          <AnchorHeading id="correlation">Why correlation matters</AnchorHeading>
          <p>
            Ethereum already punishes correlated <em>slashing</em> harder than isolated slashing:
            penalties scale with how many validators are slashed in the same window, so an event
            that takes out many validators at once costs each of them far more than a one-off
            mistake would.
          </p>
          <p>
            <a
            ...
            <em>outages</em>: diversified setups would pay smaller downtime penalties, highly
            correlated setups steeper ones. Spreading across the six slices isn&apos;t just
        ...
        <section>
          <AnchorHeading id="nuances">Nuances and limits</AnchorHeading>
          <p>
            This section lists the nuances the assessment leaves out, so you can weigh them
            yourself.
          </p>

          <AnchorHeading id="three-colors" as="h3">
            Why three colors
          </AnchorHeading>
          <p>
        ...
        <section>
          <AnchorHeading id="whats-next">What&apos;s next</AnchorHeading>
          <p>
        ...
        <section>
          <AnchorHeading id="further-reading">Further reading</AnchorHeading>
          <ul>
            <li>
              <a
            ...
            <li>
              <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer">
                Validator Beat source code
              </a>
              {" "}— this site is open source; the full scoring rubric lives in{" "}
              <code>lib/rubric</code>.
            </li>
          </ul>
        </section>
